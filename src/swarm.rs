...
pub async fn run_swarm_web(
    ...
    loop {
        ...
        loop {
            ...
            Delay::new(Duration::from_millis(SIMULATION_SLEEP_MS)).await;
        }
...
pub async fn run_swarm_web(
    _shared_brain: Arc<RwLock<Option<PolicyBrain>>>,
    _shared_stats: Arc<RwLock<SwarmStats>>,
    _shared_snapshot: Arc<RwLock<SwarmSnapshot>>,
    _reset_signal: Arc<AtomicU64>,
) {
}
